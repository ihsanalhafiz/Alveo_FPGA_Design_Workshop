...
LINK_OUTPUT := $(BUILD_DIR)/streamhls.link.xclbin
PACKAGE_OUT = ./package.$(TARGET)


VPP_PFLAGS := 
CMD_ARGS = -x $(BUILD_DIR)/streamhls.xclbin
...
all: check-platform check-device check-vitis $(EXECUTABLE) $(BUILD_DIR)/streamhls.xclbin emconfig

.PHONY: host
host: $(EXECUTABLE)

.PHONY: build
build: check-vitis check-device $(BUILD_DIR)/streamhls.xclbin
