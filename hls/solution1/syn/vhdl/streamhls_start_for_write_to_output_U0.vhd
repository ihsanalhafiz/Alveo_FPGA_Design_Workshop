...
entity streamhls_start_for_write_to_output_U0 is 
    generic (
...
architecture rtl of streamhls_start_for_write_to_output_U0 is

    component streamhls_start_for_write_to_output_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
...
begin
----------------------- Instantiation -----------------------
    U_streamhls_start_for_write_to_output_U0_ShiftReg : streamhls_start_for_write_to_output_U0_ShiftReg
    generic map (
...
entity streamhls_start_for_write_to_output_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 2;
        DEPTH      : integer := 3);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end streamhls_start_for_write_to_output_U0_ShiftReg;

architecture rtl of streamhls_start_for_write_to_output_U0_ShiftReg is
