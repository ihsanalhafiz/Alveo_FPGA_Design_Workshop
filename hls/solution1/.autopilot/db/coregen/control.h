...
#define CONTROL_ADDR_HBM_DATA_DATA    0x10
#define CONTROL_BITS_HBM_DATA_DATA    64
#define CONTROL_ADDR_OUTPUT_DATA_DATA 0x1c
#define CONTROL_BITS_OUTPUT_DATA_DATA 64
