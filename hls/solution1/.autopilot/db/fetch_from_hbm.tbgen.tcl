...
set C_modelName {fetch_from_hbm}
set C_modelType { void 0 }
set C_modelArgList {
	{ input_stream int 512 regular {fifo 1 volatile }  }
	{ gmem int 512 regular {axi_master 0}  }
	{ hbm_data int 64 regular  }
}
set hasAXIMCache 0
set AXIMCacheInstList { }
set C_modelArgMapList {[ 
	{ "Name" : "input_stream", "interface" : "fifo", "bitwidth" : 512, "direction" : "WRITEONLY"} , 
 	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "bitSlice":[ {"cElement": [{"cName": "hbm_data","offset": { "type": "dynamic","port_name": "hbm_data","bundle": "control"},"direction": "READONLY"},{"cName": "output_data","offset": { "type": "dynamic","port_name": "output_data","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "hbm_data", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} ]}
...
set portList { 
	...
	{ input_stream_din sc_out sc_lv 512 signal 0 } 
	{ input_stream_num_data_valid sc_in sc_lv 3 signal 0 } 
	{ input_stream_fifo_cap sc_in sc_lv 3 signal 0 } 
	{ input_stream_full_n sc_in sc_logic 1 signal 0 } 
	{ input_stream_write sc_out sc_logic 1 signal 0 } 
	{ start_out sc_out sc_logic 1 signal -1 } 
	{ start_write sc_out sc_logic 1 signal -1 } 
	{ hbm_data sc_in sc_lv 64 signal 2 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "input_stream_din", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "input_stream", "role": "din" }} , 
 	...
 	{ "name": "hbm_data", "direction": "in", "datatype": "sc_lv", "bitwidth":64, "type": "signal", "bundle":{"name": "hbm_data", "role": "default" }}  ]}
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "", "Child" : ["1"],
		...
		"IsBlackBox" : "0",
		"Port" : [
			{"Name" : "input_stream", "Type" : "Fifo", "Direction" : "O", "DependentProc" : ["0"], "DependentChan" : "0", "DependentChanDepth" : "4", "DependentChanType" : "0",
				"BlockSignal" : [
...
set Spec2ImplPortList { 
	input_stream { ap_fifo {  { input_stream_din fifo_data_in 1 512 }  { input_stream_num_data_valid fifo_status_num_data_valid 0 3 }  { input_stream_fifo_cap fifo_update 0 3 }  { input_stream_full_n fifo_status 0 1 }  { input_stream_write fifo_port_we 1 1 } } }
	...
	hbm_data { ap_none {  { hbm_data in_data 0 64 } } }
}
