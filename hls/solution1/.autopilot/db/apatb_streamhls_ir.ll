; ModuleID = '/home/miahafiz/Alveo_FPGA_Design_Workshop/hls/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
source_filename = "llvm-link"
target datalayout = "e-m:e-i64:64-i128:128-i256:256-i512:512-i1024:1024-i2048:2048-i4096:4096-n8:16:32:64-S128-v16:16-v24:32-v32:32-v48:64-v96:128-v192:256-v256:256-v512:512-v1024:1024"
target triple = "fpga64-xilinx-none"

; Function Attrs: noinline
define void @apatb_streamhls_ir(float* noalias nocapture nonnull readonly "maxi" %hbm_data, float* noalias nocapture nonnull "maxi" %output_data) local_unnamed_addr #0 {
entry:
  %hbm_data_copy = alloca float, align 512
  %output_data_copy = alloca float, align 512
  call fastcc void @copy_in(float* nonnull %hbm_data, float* nonnull align 512 %hbm_data_copy, float* nonnull %output_data, float* nonnull align 512 %output_data_copy)
  call void @apatb_streamhls_hw(float* %hbm_data_copy, float* %output_data_copy)
  call void @copy_back(float* %hbm_data, float* %hbm_data_copy, float* %output_data, float* %output_data_copy)
  ret void
}
...
declare void @apatb_streamhls_hw(float*, float*)
...
define void @streamhls_hw_stub_wrapper(float*, float*) #4 {
entry:
  call void @copy_out(float* null, float* %0, float* null, float* %1)
  call void @streamhls_hw_stub(float* %0, float* %1)
  call void @copy_in(float* null, float* %0, float* null, float* %1)
  ret void
}

declare void @streamhls_hw_stub(float*, float*)
